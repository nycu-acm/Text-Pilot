...
def main():
    try:
                            ...
                            if flux_input and mask_file.exists():
                                ...
                                EnvTask(
                                    ...
                                    commands=[
                                        ...
                                        f"--prompt \"Render text '{info.get('action','')}'.\" "
                                ...
                                if not gen_flux_input or not instructions:
                                    ...
                                    for idx, mask_path in enumerate(mask_files, start=1):
                                        ...
                                        EnvTask(
                                            ...
                                            f"--prompt \"Render text '{text_to_generate}'\" "
        ...
        print("✅ 全部階段任務執行完畢。")
        target_root = Path("/home/pmd/Desktop/Alex/Datasets/MARIOEval/MARIOEval/LAIONEval4000/iter_exp")
        final_base = Path("/home/pmd/Desktop/Alex/images/Final_Output")
